...
class MainView extends GetView<MainController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: Container(
        width: .75.sw, // Slightly wider to accommodate content comfortably
        ...
        decoration: ShapeDecoration(
          ...
          color: const Color(0xFF070F26), // Dark background color matching image
          // Or use: color: R.theme.secondary,
        ),
        child: Column(
          children: [

            // 1. Header Section (Close Button + Brand Info)
            SafeArea(
              bottom: false,
              child: Column(
                children: [
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: const Color(0xFF151E32).withOpacity(0.08),
                        ...
                        child: Column(
                          ...
                          children: [
                            MyText(
                              ...
                              color: Colors.white, // Or R.theme.white
                            ),
                            4.sbh,
                            MyText(
                              ...
                              color: Colors.grey, // Or R.theme.grey
                            ),
                          ],
                        ),
                      ),
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    //     controller.closeDrawer();
                    //   },
                    //   // Custom Switch to match the Green toggle
                    //   trailing: SizedBox(
                    //     height: 25,
                    //     child: Switch(
                    //       value: true,
                    //       activeColor: Colors.white,
                    //       activeTrackColor: const Color(0xFF00C569), // Green track
                    ...
                    DrawerItem(
                      ...
                      onTap: () {
                        controller.closeDrawer();
                        Get.toNamed(Routes.RETURN_POLICY);
                      },
                    ),
                    DrawerItem(
                      title: 'FAQ\'s',
